...
**[Kdenlive](https://kdenlive.org/)**, [Shotcut](https://shotcut.org), [Olive](https://www.olivevideoeditor.org/), [OpenShot](https://www.openshot.org/), [Flowblade](https://jliljebl.github.io/flowblade/), [Pitivi](https://www.pitivi.org/) | Other FOSS video editors | Lin, Mac, Win | Movie Maker
...
[git-filter-repo](https://github.com/newren/git-filter-repo) | Rewrite the whole Git history | Python | `git-filter-branch`, BFG Repo-Cleaner
...
[I don't care about cookies](https://www.i-dont-care-about-cookies.eu/) | Clean more useless shit from the Internet | Fox, Chrm
